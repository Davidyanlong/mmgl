...
export { _Math as Math } from './maths/Math.js';
...
export { Box3 } from './maths/Box3.js';
export { Line3 } from './maths/Line3.js';
export { Euler } from './maths/Euler.js';
export { Vector4 } from './maths/Vector4.js';
export { Vector3 } from './maths/Vector3.js';
